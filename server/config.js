...
// basic app config
cfg.port = process.env.ANNOTATRIX_PORT || process.env.PORT || 5316;
cfg.host = process.env.ANNOTATRIX_HOST || process.env.HOST || "localhost";
cfg.protocol = process.env.ANNOTATRIX_PROTOCOL || process.env.PROTOCOL || "http";
cfg.corpora_path =
    process.env.ANNOTATRIX_CORPORA_PATH || process.env.CORPORA_PATH || process.env.PATH_TO_CORPORA || "corpora";
cfg.secret = process.env.ANNOTATRIX_SECRET || process.env.SECRET || "dev secret";
cfg.environment = process.env.ANNOTATRIX_ENV || process.env.NODE_ENV || "development";
...
cfg.users_db_path = process.env.ANNOTATRIX_USERS_DB_PATH || ".users";
