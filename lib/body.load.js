...
head.js(
    ...
    './lib/spyysalo/annodoc.js',
    './lib/spyysalo/conllu.js',
...
function exportCorpora() {
    ...
    // commented out, as, I believe, there is no need in detecting the type:
    // default .txt can be already included in the default name, otherwise
    // the name of the loaded file is used as default
    // var type = ".txt";
    // if (FORMAT == "CoNLL-U") {
    //     type = ".conllu";
    // }
...
function graphEdit(){
    ...
    var arcs = $("g[data-from]");

    $.each(arcs, function(n, arc) {
        arc.addEventListener("click", selectArc);
    })
}
