...
class Menu {
  ...
  bind() {
    ...
    $("[name=\"logout\"]").click(e => { utils.link(`/logout?treebank_id=${utils.getTreebankId()}`, "_self"); });
    $("[name=\"login\"]").click(e => { utils.link(`/oauth/login?treebank_id=${utils.getTreebankId()}`, "_self"); });
    $("[name=\"manage-repos\"]").click(e => { utils.link("/repos"); });
    $("[name=\"manage-permissions\"]").click(e => { utils.link("/permissions"); });
