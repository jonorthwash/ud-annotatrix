...
describe("dependency classes", () => {
  function getClasses(sent, token, head) { return utils.validate.depEdgeClasses(sent, token, head); }

  it("should detect leaf nodes", () => { throw new Error("not implemented"); });
...
describe("POS node classes", () => {
  it("should have tests", () => { throw new Error("not implemented"); });
});
