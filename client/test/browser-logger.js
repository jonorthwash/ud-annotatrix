...
// with this data
const data = [
  {param: "CRITICAL", levelName: "CRITICAL", logs: 1, infos: 0, warns: 0, errors: 1},
  {param: "ERROR", levelName: "ERROR", logs: 2, infos: 0, warns: 0, errors: 2},
  {param: "WARN", levelName: "WARN", logs: 3, infos: 0, warns: 1, errors: 2},
  {param: "INFO", levelName: "INFO", logs: 4, infos: 1, warns: 1, errors: 2},
  {param: "DEBUG", levelName: "DEBUG", logs: 6, infos: 1, warns: 1, errors: 2},
  {param: "INVALID", levelName: "CRITICAL", logs: 1, infos: 0, warns: 0, errors: 1},
];
...
describe("browser-logger.js", () => {
  ...
  _.each(data, datum => {
    describe(`initialized with "${datum.param}"`, () => {
      ...
      it(`should have levelName "${datum.levelName}"`, () => { expect(log._levelName).to.equal(datum.levelName); });
      ...
      it(`should call console.{whatever} correctly`, () => {
        ...
        const sandbox = sinon.createSandbox(), consoleTrace = sandbox.stub(console, "trace"),
              consoleLog = sandbox.stub(console, "log"), consoleInfo = sandbox.stub(console, "info"),
              consoleWarn = sandbox.stub(console, "warn"), consoleError = sandbox.stub(console, "error");
